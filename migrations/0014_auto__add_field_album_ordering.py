...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.ordering'
        db.add_column(u'comenius_album', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.ordering'
        db.delete_column(u'comenius_album', 'ordering')
    ...
    models = {
        ...
        u'comenius.album': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'Album'},
