...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.pdf'
        db.alter_column(u'comenius_project', 'pdf', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Project.pdf'
        db.alter_column(u'comenius_project', 'pdf', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
