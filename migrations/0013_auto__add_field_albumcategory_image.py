...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumCategory.image'
        db.add_column(u'comenius_albumcategory', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumCategory.image'
        db.delete_column(u'comenius_albumcategory', 'image')
