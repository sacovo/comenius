...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mobility'
        db.create_table(u'comenius_mobility', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'comenius', ['Mobility'])

        # Adding M2M table for field reports on 'Mobility'
        m2m_table_name = db.shorten_name(u'comenius_mobility_reports')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mobility', models.ForeignKey(orm[u'comenius.mobility'], null=False)),
            ('report', models.ForeignKey(orm[u'comenius.report'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mobility_id', 'report_id'])


    def backwards(self, orm):
        # Deleting model 'Mobility'
        db.delete_table(u'comenius_mobility')

        # Removing M2M table for field reports on 'Mobility'
        db.delete_table(db.shorten_name(u'comenius_mobility_reports'))
