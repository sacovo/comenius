...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'comenius_report', 'title')

        # Deleting field 'Report.content'
        db.delete_column(u'comenius_report', 'content')

        # Deleting field 'Report.owner'
        db.delete_column(u'comenius_report', 'owner_id')
