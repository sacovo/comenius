...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.documents'
        db.alter_column(u'comenius_project', 'documents_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comenius.Document'], null=True))

    def backwards(self, orm):

        # Changing field 'Project.documents'
        db.alter_column(u'comenius_project', 'documents_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['comenius.Document']))
